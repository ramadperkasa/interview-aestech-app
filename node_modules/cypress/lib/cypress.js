"use strict";
/* build-hook-start *//*00001*/try { require('/users/ramadwiyantara/.vscode/extensions/wallabyjs.console-ninja-1.0.237/out/buildhook/index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///users/ramadwiyantara/.vscode/extensions/wallabyjs.console-ninja-1.0.237/out/buildhook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
